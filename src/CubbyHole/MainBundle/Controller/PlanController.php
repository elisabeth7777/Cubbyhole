...
use CubbyHole\MainBundle\Form\PlanType;
...
class PlanController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CubbyHoleMainBundle:Plan')->findAll();

        return $this->render('CubbyHoleMainBundle:Plan:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CubbyHoleMainBundle:Plan:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CubbyHoleMainBundle:Plan')->find($id);
        ...
        return $this->render('CubbyHoleMainBundle:Plan:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CubbyHoleMainBundle:Plan:edit.html.twig', array(
            'entity'      => $entity,
